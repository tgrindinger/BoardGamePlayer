...
public record GetUserResponse(Guid Id, string Name, IEnumerable<Guid> GameIds);
    ...
    : IRequestHandler<GetUserQuery, GetUserResponse>
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        return await Task.FromResult(new GetUserResponse(user.Id, user.Name, user.GameIds));
    }
}
